...
readonly FIXTURE_DIR="${REPO_DIR}/haifa-agent-applications/haifa-agent-cli/src/test/resources/coding-e2e/fixtures/single-file-bugfix"
...
{
  print -r -- "model:"
  print -r -- "  providerId: deepseek"
  print -r -- "  modelId: deepseek-v4-pro"
