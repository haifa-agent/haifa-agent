...
models:
  default: gpt-5.6-sol
  maxResponseBytes: 4194304 # 1 MiB..32 MiB; applies to every configured model adapter
  providers:
    - id: openai-codex
