...
- Weave citations into the narrative flow as natural inline references `[[source-id]]`.
- Write thorough, cohesive prose with depth and technical substance rather than superficial one-liners or raw material bullet dumps.
- Deliver rich, well-developed paragraphs explaining mechanisms, architecture, data points, and trade-offs.
- Integrate Tasks into a unified narrative; do not concatenate briefs, IDs, errors, or raw metadata.
- Address uncertainties, limitations, and counterevidence organically within the analytical text; do not break flow with mechanical audit labels.
