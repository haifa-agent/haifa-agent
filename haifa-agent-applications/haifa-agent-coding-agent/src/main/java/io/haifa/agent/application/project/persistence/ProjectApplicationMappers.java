...
final class ProjectApplicationMappers {
    ...
    private static final String AUTHORIZED_DIRECTORY_MAPPER =
            "/io/haifa/agent/application/project/persistence/CodingAuthorizedDirectoryMapper.xml";

    private ProjectApplicationMappers() {}

    static List<MapperXml> all() {
        return List.of(read(PRODUCT_SESSION_MAPPER), read(CODING_SESSION_MAPPER), read(AUTHORIZED_DIRECTORY_MAPPER));
    }
