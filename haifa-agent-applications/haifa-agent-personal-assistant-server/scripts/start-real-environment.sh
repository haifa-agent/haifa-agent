...
if http_endpoint_is_healthy "$BACKEND_HEALTH_URI"; then
    ...
    (
        ...
        export HAIFA_PERSONAL_MODELPROVIDERS_0_DIALECTID="deepseek-openai-chat"
        export HAIFA_PERSONAL_MODELPROVIDERS_0_DIALECTVERSION="1.0"
        export HAIFA_PERSONAL_MODELPROVIDERS_0_NATIVESTREAMING="true"
