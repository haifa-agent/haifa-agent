    ...
    void rendersStructuredMarkdownDeterministically() {
        SemanticConversationSummaryV1 summary = new SemanticConversationSummaryV1(
                ...
                List.of(new SemanticSummaryItem(
                        "c01", "ENV-ACCEPT-V3 template", List.of("m001"), SemanticConfidence.OBSERVED)),
                new SemanticProgress(
                        List.of(new SemanticSummaryItem(
                                "p01", "3-day monitoring complete", List.of("m002"), SemanticConfidence.OBSERVED)),
                        List.of(new SemanticSummaryItem(
                                "p02", "Archive energy report", List.of("m003"), SemanticConfidence.OBSERVED)),
                        List.of(new SemanticSummaryItem(
                                "p03", "Noise issue rectification", List.of("m004"), SemanticConfidence.OBSERVED))),
                List.of(new SemanticDecisionItem(
                        ...
                        List.of("m005"))),
                List.of(new SemanticSummaryItem(
                        "n01", "Archive by Sept 30", List.of("m003"), SemanticConfidence.OBSERVED)),
                List.of(new SemanticSummaryItem(
                        "ctx01", "Reports: QHJC-2026-0615", List.of("m002"), SemanticConfidence.OBSERVED)),
                List.of(new SemanticSummaryItem(
                        "q01", "Confirm archive recipient", List.of("m003"), SemanticConfidence.OBSERVED)));
