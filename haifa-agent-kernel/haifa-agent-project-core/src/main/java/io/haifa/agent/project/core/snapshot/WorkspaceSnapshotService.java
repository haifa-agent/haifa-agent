package io.haifa.agent.project.core.snapshot;
...
import io.haifa.agent.project.snapshot.WorkspaceSnapshotEvidenceProvider;
import io.haifa.agent.project.snapshot.WorkspaceSnapshotId;
import io.haifa.agent.project.snapshot.WorkspaceSnapshotStatus;
