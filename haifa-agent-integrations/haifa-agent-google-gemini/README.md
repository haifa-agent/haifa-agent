...
- `google-antigravity` + `gemini-3.7-flash-tiered` + `google-gemini-generate-content` + `antigravity-direct`
- `google-antigravity` + `gemini-3.8-flash-tiered` + `google-gemini-generate-content` + `antigravity-direct`
- `google-antigravity` + `gemini-pro-agent` + `google-gemini-generate-content` + `antigravity-direct`
