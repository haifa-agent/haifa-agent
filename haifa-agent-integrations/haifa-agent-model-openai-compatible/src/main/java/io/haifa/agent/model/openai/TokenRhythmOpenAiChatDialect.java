...
/**
 * TokenRhythm Chat Completions semantics verified against its cumulative streaming usage behavior.
 *
 * supplied by the user before enabling real evaluation.
 */
final class TokenRhythmOpenAiChatDialect implements OpenAiCompatibleDialect {
    ...
    @Override
    public String id() {
        return OpenAiCompatibleDialects.TOKENRHYTHM;
    }
    ...
    private static void validateFrozenHost(String endpointHost, Map<String, Object> options) {
        ...
        if (!(configured instanceof String host)
            ...
            throw new IllegalArgumentException("TokenRhythm endpoint_host does not match the frozen endpoint");
        }
    }
    ...
    private static void validateOptions(Map<String, Object> options) {
        ...
        if (endpointHost != null
            ...
            throw new IllegalArgumentException("TokenRhythm endpoint_host is not allowed");
        }
    }
}
