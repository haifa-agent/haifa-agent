...
final class SqliteAggregateTestData {

    static final Instant NOW = Instant.parse("2026-07-25T00:00:00Z");

    private SqliteAggregateTestData() {}

    static AgentRun prepareRun(SqliteStoreFoundation foundation) {
        foundation
                .agentSessions()
